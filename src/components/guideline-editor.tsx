...
function defineLessonExtension() {
  return union(
    ...
    definePlaceholder({ placeholder: 'Start writing your grading guidlines for the AI assistant to follow. If both activity types selected, write guidelines for both...' }),
  )
}
...
export default function GuideLineEditor({ content, onChange }: LessonEditorProps) {
