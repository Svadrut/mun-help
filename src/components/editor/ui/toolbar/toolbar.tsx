...
import { InsertSnippetButton } from "@/src/components/InsertSnippetButton";
...
export default function Toolbar({ newSlide = false }: { newSlide?: boolean }) {
